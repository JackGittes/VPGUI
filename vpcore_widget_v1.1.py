...
class TopTool(QWidget):


class ResultImg(QWidget):
    def __init__(self):
        ...
        imgs1 = cv2.resize(imgs1, (300,200))
        imgs2 = cv2.resize(imgs2, (300,200))
        h, w, ch = imgs1.shape
        qImg1 = QImage(imgs1.data, w, h, 3*w, QImage.Format_RGB888)
        qImg2 = QImage(imgs2.data, w, h, 3*w, QImage.Format_RGB888)

        hLayout.addWidget(QPixmap(qImg1))
        hLayout.addWidget(QPixmap(qImg2))
